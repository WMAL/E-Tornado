...
Begin VB.Form frmLogin 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox txtUserName 
         ...
         TabIndex        =   1
         Text            =   "Click to view"
         ToolTipText     =   "choose your login name"
         Top             =   360
         Width           =   2295
      End
...
Public Sub getnetinfo()
    ...
    thestatus = Trim(OpenURL("http://xxxxxx.com/wolf/data/v16/client-ver-16.pp"))
   ...
   'wait dont hang the gui
    ...
    If Trim(thestatus) = 0 Then
        ...
        MsgBox OpenURL("http://xxxxxx.com/wolf/data/v16/lockmsg.pp")
        End
...
Open App.path & "\l.sys" For Output As #1
    Print #1, Trim(OpenURL("http://xxxxxx.com/wolf/licences.pp"))
Close #1
